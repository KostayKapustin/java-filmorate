...
public class UserService {
    ...
    public void addFriends(int userId, int friendId) {
        checkingExistenceUsers(userId, friendId);
    ...
    public List<User> getListMutualFriends(int id, int otherId) {
        ...
        checkingExistenceUsers(id, otherId);
    ...
    public void checkingExistenceUsers(int userId, int friendId) {
    ...
    public void checkingExistenceUser(int userId) {
        if (!userStorage.getUsers().containsKey(userId))
            throw new ResponseStatusException(HttpStatus.NOT_FOUND,
                    String.format("Пользователь с userId %d не существует", userId));
    }
